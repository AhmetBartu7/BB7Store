...
{
    public class CustomersUpdateValidation : AbstractValidator<DtoCustomersUpdate>
    {
        public CustomersUpdateValidation()
        {
            ...
            RuleFor(x => x.Disctrict).NotEmpty().WithMessage("Boş Bırakılmaz");
            RuleFor(x => x.Disctrict).MaximumLength(50).WithMessage("Maximum 50 Karakter girebilirsiniz");
